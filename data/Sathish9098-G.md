...
## [G-2]  <X> += <Y> or <X>-=<Y> COSTS MORE GAS THAN <X> = <X> + <Y> OR <X>=<X> - <Y> FOR STATE VARIABLES . FOR EVERY CALL CAN SAVE 13 GAS 

Instances (9):

Approximate Gas Saved : 117
...
### [G-4] ADD UNCHECKED {} FOR SUBTRACTIONS WHERE THE OPERANDS CANNOT UNDERFLOW BECAUSE OF A PREVIOUS REQUIRE() OR IF-STATEMENT . This saves 30-40 gas


Instances (2):

Approximate Gas Saved : 80
...
### [G-5] Use functions instead of modifiers
...
### [G-7] Use assembly for address(0) checks 

Saves 3 gas 

Instances (8):

Approximate Gas Saved : 24
...
### [G-8] USE REQUIRE INSTEAD OF ASSERT
...
### [G-9] SPLITTING ASSERT() STATEMENTS THAT USE && SAVES GAS
...
### [G-17] Internal functions not called by contract can be removed to save the gas
